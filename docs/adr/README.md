...
This directory materializes the stable Architecture Decision Register from Canonical Handoff Section 80.7 and later accepted Sections, version `0.5.8`.
...
- `ADR-0018` through `ADR-0033` are `Accepted` decisions and must be followed by affected Work Packages.
