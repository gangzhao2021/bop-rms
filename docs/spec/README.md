...
- Current discussion node: `WP-2332 - Pickup Removal Current Authority Across Awaits`
...
- [WP-2332](./work-packages/WP-2332.md) checks current-authorized Pickup removal across persistence and replay waits.
  Ordering878/878, API571/571 and actual Cart PostgreSQL9/9 pass; original recovery remains available.

- [WP-2331](./work-packages/WP-2331.md) checks fresh Pickup item authority and lifecycle across Catalog and persistence awaits.
  Ordering865/865 plus final affected53/53, API571/571 and actual Cart PostgreSQL9/9 pass.

- [WP-2330](./work-packages/WP-2330.md) reconciles design status with accepted Cart/Session decisions and actual local browser/Quote evidence; remaining source and external gates stay explicit.

- [WP-2329](./work-packages/WP-2329.md) fences new Quote attachment writes against fresh Cart/Quote expiry after Pricing waits.
  Affected77/77 and actual PostgreSQL5/5 pass; original historical replay remains available under current authority.

- [WP-2328](./work-packages/WP-2328.md) rechecks current Pickup Quote authority across Pricing, persistence and replay.
  Final affected72/72 and actual Quote PostgreSQL5/5 pass; post-commit denial preserves original recovery.

- [WP-2327](./work-packages/WP-2327.md) verifies simultaneous same-table participants through the actual browser and owner stores.
  Lab1/1 passes: shared Cart version6, own-item edits and foreign-note/control isolation, with actual invitation regeneration.

- [WP-2326](./work-packages/WP-2326.md) shares current consumed-admission binding checks between admission and the local Cart runtime.
  API571/571 and the actual desktop/mobile lab1/1 pass without a duplicate lab-only guard.

- [WP-2325](./work-packages/WP-2325.md) verifies desktop/mobile Dining admission, menu add and Cart edits against real owner stores, including the last-item empty-state fix.
  Lab1/1, PWA646/646 and complete stage components pass; integration passes without forced cache bypass. External launch readiness remains separate.

- [WP-2324](./work-packages/WP-2324.md) opts Dining item commands into the API with scoped owner stores and safe current views.
  API563/563, final affected12/12, Cart PostgreSQL9/9 and static/security checks pass; browser activation remains next.

- [WP-2323](./work-packages/WP-2323.md) bounds operation snapshots by Cart/Guest and composes current Dining item authority with actual owner persistence.
  Ordering829/829, final affected41/41, Cart PostgreSQL9/9 and static/security gates pass; API wiring remains next.
...
- [WP-2320](./work-packages/WP-2320.md) presents participant-owned Cart controls with PWA639/639, selected browser50/50 and build/offline security passing.
  Owner-approved affected-check verification reuses unchanged backend evidence; no new full uncached run is claimed.

- [WP-2319](./work-packages/WP-2319.md) composes current CSRF-authorized Dining Cart selection and safe reads in the local API runtime.
  API551/551, Cart PostgreSQL9/9, existing customer lab, full verification and forced integration pass.

- [WP-2318](./work-packages/WP-2318.md) projects current-authorized shared Dining Carts with participant note minimization.
  Ordering790/790, Cart PostgreSQL9/9, full verification and forced uncached integration pass.

- [WP-2317](./work-packages/WP-2317.md) requires current Identity/Dining authority around shared Cart selection and original-operation recovery.
  Ordering753/753, Cart PostgreSQL9/9, full verification and forced uncached integration pass.

- [WP-2316](./work-packages/WP-2316.md) persists initial shared Dining Cart selection atomically with operation/Audit history.
  Ordering704/704, Cart PostgreSQL9/9, 101 migrations, full verification and forced uncached integration pass.

- [WP-2315](./work-packages/WP-2315.md) defines initial shared Dining Cart creation/selection without replacing history.
  Ordering660/660, full verification and forced uncached integration pass; atomic persistence remains separate.

- [WP-2314](./work-packages/WP-2314.md) reads current shared Dining Carts through scoped PostgreSQL owner queries.
  Ordering618/618, Cart PostgreSQL8/8, full verification and forced uncached integration pass.

- [WP-2313](./work-packages/WP-2313.md) implements current-authorized shared Dining Cart reads.
  Ordering591/591, full verification and forced uncached integration pass; persistence and runtime remain separate.

- [WP-2312](./work-packages/WP-2312.md) bounds entry responses and prevents stale credential publication.
  PWA634/634, browser76/76, real Dining lab, security/build, full verification and forced uncached integration pass.

- [WP-2311](./work-packages/WP-2311.md) guards entry responses against stale page/client lifecycles.
  PWA613/613, browser76/76, real Dining lab, security/build, full verification and forced uncached integration pass.

- [WP-2310](./work-packages/WP-2310.md) connects actual browser Dining admission to isolated persisted services.
  PWA612/612, browser53/53, real HTTPS/database lab, security/build, full verification and forced uncached integration pass.

- [WP-2309](./work-packages/WP-2309.md) assembles optional Dining admission in the scoped local runtime.
  API508/508, real PostgreSQL/runtime recovery and entry/menu lab, full verification and forced uncached integration pass.

- [WP-2308](./work-packages/WP-2308.md) adds contextual Dining admission and explicit recovery UI.
  PWA612/612, browser53/53, security111/111/build, real entry/menu lab, full verification and forced uncached integration pass.

- [WP-2307](./work-packages/WP-2307.md) coordinates foreground Join and binding recovery.
  PWA596/596, security111/111/build, actual PostgreSQL/HTTP double-ack recovery, full verification and forced uncached integration pass.

- [WP-2306](./work-packages/WP-2306.md) connects browser Join transport to verified HTTP recovery.
  PWA561/561, security111/111/build, actual PostgreSQL/HTTP, full verification and forced uncached integration pass.

- [WP-2305](./work-packages/WP-2305.md) adds same-origin Join HTTP and Join-to-binding recovery acceptance.
  API500/500, actual PostgreSQL/HTTP recovery, full verification and forced uncached integration pass.

- [WP-2304](./work-packages/WP-2304.md) composes current Identity/QR authority and request-bound abuse admission with Dining joining.
  API456/456, actual PostgreSQL cooldown/recovery/revocation acceptance, full verification and forced uncached integration pass.

- [WP-2303](./work-packages/WP-2303.md) adds owner-selected current-version Guest joining with unchanged atomic fences.
  Dining951/951, actual PostgreSQL replay/race acceptance, full verification and forced uncached integration pass.

- [WP-2302](./work-packages/WP-2302.md) adds private foreground Dining binding coordination.
  PWA508/508, security111/111, actual coordinator/client/HTTP/PostgreSQL recovery, full verification and forced uncached integration pass.

- [WP-2301](./work-packages/WP-2301.md) adds the independent PWA Dining binding client.
  PWA476/476, security111/111, actual client/HTTP/PostgreSQL acceptance, full verification and forced uncached integration pass.

- [WP-2300](./work-packages/WP-2300.md) adds same-origin Dining credential transport and HTTP response-loss recovery.
  API431/431, Identity476/476, privacy8/8, actual PostgreSQL/HTTP acceptance, full verification and forced uncached integration pass.

- [WP-2299](./work-packages/WP-2299.md) requires current Dining-bound identity facts with original consumed-admission assignment checks.
  Dining928/928, API393/393, real PostgreSQL Closing/Move-away-and-back acceptance, full verification and forced uncached integration pass.

- [WP-2298](./work-packages/WP-2298.md) composes real Dining and Identity services through public ports with invocation-local Guest authority and Dining-owned context validation.
  API388/388, Dining843/843, real combined PostgreSQL acceptance, full verification and forced uncached integration pass.

- [WP-2297](./work-packages/WP-2297.md) exposes current-authorized, read-only Dining admission eligibility without consuming or granting a lease.
  Dining821/821, actual PostgreSQL acceptance, full verification and forced uncached integration pass.

- [WP-2296](./work-packages/WP-2296.md) coordinates acknowledged Dining credential delivery, admission consumption and active-candidate recovery.
  Identity476/476, actual PostgreSQL coordinator acceptance, full verification and forced uncached integration pass.

- [WP-2295](./work-packages/WP-2295.md) persists independent Dining credential preparations with atomic Identity activation and Audit.
  Identity431/431, Identity PostgreSQL6/6, full verification and forced uncached integration pass; application composition and transport remain separate.

- [WP-2294](./work-packages/WP-2294.md) adds an independent acknowledged-delivery preparation contract for Dining credentials.
  Identity402/402, full verification and forced uncached integration pass; persistence, transport and production context remain separate.

- [WP-2293](./work-packages/WP-2293.md) captures binding writer commands and scope before asynchronous work.
  Identity291/291, actual PostgreSQL mutation-barrier acceptance, full verification and forced uncached integration pass.

- [WP-2292](./work-packages/WP-2292.md) closes outer Guest binding transition inputs and requires exact boolean possession checks.
  Identity264/264, full verification and forced uncached integration pass after34 baseline regression failures were reproduced.

- [WP-2291](./work-packages/WP-2291.md) exercises actual Dining consumption and Identity binding across commit failures.
  Dining785/785, Dining PostgreSQL9/9, full verification and forced uncached integration pass; public context providers and credential delivery recovery remain separate.

- [WP-2290](./work-packages/WP-2290.md) adds atomic Dining admission consumption, immutable recovery and current-fact fences.
  Dining785/785, Dining PostgreSQL9/9, full verification and forced uncached integration pass; Identity evidence composition remains separate.

- [WP-2289](./work-packages/WP-2289.md) adds current-Guest-authorized admission consumption and original receipt validation.
  Dining760/760, full verification and forced uncached integration pass; durable owner writes and Identity evidence composition remain separate.

- [WP-2288](./work-packages/WP-2288.md) implements the pure one-time admission transition.
  Dining678/678, full verification and forced uncached integration pass; durable consumption and Identity composition remain separate.

- [WP-2287](./work-packages/WP-2287.md) fences regeneration against the explicit predecessor generation.
  Dining623/623, Dining PostgreSQL8/8, full verification and forced uncached integration pass.

- [WP-2286](./work-packages/WP-2286.md) connects current-authorized Join reissue to committed Move facts.
  Dining610/610, Dining PostgreSQL8/8, full verification and forced uncached integration pass.

- [WP-2285](./work-packages/WP-2285.md) defines explicit fresh Join generation after a committed Move.
  Public Capability145/145, full verification and forced uncached integration pass; Dining composition remains separate.

- [WP-2284](./work-packages/WP-2284.md) implements atomic Move storage and original commit receipts.
  Dining573/573, Dining PostgreSQL7/7, full verification and forced uncached integration pass.

- [WP-2283](./work-packages/WP-2283.md) retains the complete canonical Move command with its result.
  Dining547/547, full verification and forced uncached integration pass; Move persistence remains separate.

- [WP-2282](./work-packages/WP-2282.md) implements atomic Dining Closing storage and scoped immutable history.
  Dining526/526, Dining PostgreSQL6/6, full verification and forced uncached integration pass.

- [WP-2281](./work-packages/WP-2281.md) corrects current Closing authority and complete result validation.
  Dining489/489, Task32/32, full verification and forced uncached integration pass.

- [WP-2280](./work-packages/WP-2280.md) implements coherent current Dining participation reads.
  Dining442/442, Dining PostgreSQL5/5, full verification and forced uncached integration pass.

- [WP-2279](./work-packages/WP-2279.md) binds Dining admission evidence to the exact current Guest.
  Identity200/200, Guest22/22, joint acceptance, full verification and forced integration pass.

- [WP-2278](./work-packages/WP-2278.md) implements atomic Guest Join persistence.
  Dining410/410, Dining PostgreSQL4/4, full verification and forced uncached integration pass.

- [WP-2277](./work-packages/WP-2277.md) implements atomic Join regeneration persistence.
  Dining380/380, Dining PostgreSQL3/3, full verification and forced uncached integration pass.

- [WP-2276](./work-packages/WP-2276.md) repairs fresh Join generation after consumption/expiry.
  Public Capability101/101, Dining352/352, full verification, security/Session acceptance and forced integration pass.

- [WP-2275](./work-packages/WP-2275.md) implements atomic Dining Session start persistence.
  Dining345/345, Table/Session-start PostgreSQL2/2, full verification and forced uncached integration pass.

- [WP-2274](./work-packages/WP-2274.md) validates current Guest authority and complete Join results.
  Dining315/315, full verification and forced uncached integration pass.

- [WP-2273](./work-packages/WP-2273.md) repairs current Staff authority and scoped Session replay.
  Dining238/238, full verification and forced uncached integration pass.

- [WP-2272](./work-packages/WP-2272.md) implements Dining-owned Table configuration persistence.
  Dining179/179, actual PostgreSQL acceptance1/1, full verification and forced uncached integration pass.
  Session and shared-Cart persistence remain separate.

- [WP-2271](./work-packages/WP-2271.md) validates Dining historical results and exact Move object identity.
  Dining154/154, full verification and forced uncached integration pass.

- [WP-2270](./work-packages/WP-2270.md) corrects the accidental Cart revision999 limit.
  Ordering535/535, Cart PostgreSQL7/7, full verification and forced uncached integration pass.

- [WP-2269](./work-packages/WP-2269.md) supplies Dining-owned current participation facts
  for the accepted shared-Cart direction. Dining97/97, full verification and forced uncached
  integration pass. Coherent persistence and caller authorization remain separate.

- [WP-2268](./work-packages/WP-2268.md) verifies continuous item-change/Quote behavior across actual local owner
  stores. Pricing248/248, Quote API9/9, Quote PostgreSQL5/5, full verification and forced
  uncached integration pass. Commercial facts remain synthetic.

- [WP-2267](./work-packages/WP-2267.md) connects Pickup product configuration to authorized binding/create flow.
  PWA430/430, browser48/48, PWA security111/111, full verification and forced uncached
  integration pass. Commercial providers and shared DineIn remain separate.

- [WP-2266](./work-packages/WP-2266.md) fences stale Session generations in foreground Pickup creation. PWA417/417,
  Cart PostgreSQL6/6, PWA security111/111, full verification and forced uncached integration pass.
  Default page activation remains separate.

- [WP-2265](./work-packages/WP-2265.md) connects authorized Pickup Add/Update commands and optional local HTTP
  composition. Ordering518/518, API360/360, Cart PostgreSQL6/6, full verification and forced
  uncached integration pass. Current Catalog authority remains mandatory.

- [WP-2264](./work-packages/WP-2264.md) connects authorized expiry reconciliation to HTTP410
  and explicit Checkout recovery. Ordering490/490, API326/326, PWA404/404, browser42/42,
  Quote PostgreSQL5/5, full verification and forced uncached integration pass locally.

- [WP-2263](./work-packages/WP-2263.md) adds the immutable Ordering expiry fence and atomic
  Audit, excluding late attachment. Ordering455/455, Quote PostgreSQL5/5, Cart PostgreSQL6/6,
  full verification and forced uncached integration pass. Authorized browser recovery remains separate.

- [WP-2262](./work-packages/WP-2262.md) verifies actual Quote HTTP persistence and lost-commit
  acknowledgement recovery across Identity, Ordering, Pricing and Audit. Quote PostgreSQL5/5,
  full verification, forced uncached integration and Secret2/2 pass. Commercial facts remain synthetic.

- [WP-2261](./work-packages/WP-2261.md) composes authorized Pickup Quote creation/recovery with
  persisted original results and optional local HTTP runtime. API319/319, full verification,
  forced uncached integration and Secret2/2 pass. Authoritative fact producers remain explicit.

- [WP-2260](./work-packages/WP-2260.md) adds current Session/CSRF and Pickup binding authorization
  before Quote attachment or history lookup. Ordering431/431, full verification, forced uncached
  integration and Secret2/2 pass locally. HTTP composition remains separate.

- [WP-2259](./work-packages/WP-2259.md) denies new Cart Quote attachment when selected-option
  prices cannot be attested by the v1 Quote contract. Ordering396/396, full verification,
  forced uncached integration and Secret2/2 pass. Option pricing and runtime composition remain separate.

- [WP-2258](./work-packages/WP-2258.md) binds Quote requests to scoped original results.
  Pricing248/248, Quote PostgreSQL4/4, full verification, forced uncached integration and
  Secret2/2 pass locally. Current caller authorization, pricing facts and runtime wiring remain separate.

- [WP-2257](./work-packages/WP-2257.md) appends complete Quote/line/tax facts and Audit atomically.
  Pricing207/207, Quote PostgreSQL3/3, full verification, forced uncached integration and Secret2/2
  pass locally. Application authorization, operation idempotency and live wiring remain separate.

- [WP-2256](./work-packages/WP-2256.md) adds scoped complete historical Quote reads and an
  immutable optional snapshot field. Pricing175/175, Quote PostgreSQL2/2, full verification, forced
  uncached integration and Secret2/2 pass. Application writes, wiring and live rollout remain separate.

- [WP-2255](./work-packages/WP-2255.md) adds a complete, immutable v1 Quote snapshot codec.
  Pricing144/144, Quote PostgreSQL1/1, full final verification, forced uncached integration and
  Secret2/2 pass locally. Persistence and live wiring remain separate.

- [WP-2254](./work-packages/WP-2254.md) preserves unresolved Checkout Quote intent through
  refresh/retry/reconnect and aligns page controls. PWA392/392, browser40/40, PWA security100/100,
  full verification, forced uncached integration and Secret2/2 pass locally. Live wiring remains separate.

- [WP-2253](./work-packages/WP-2253.md) bounds complete foreground Quote responses and rejects
  results from superseded Session contexts. PWA369/369, PWA security82/82, full verification,
  forced uncached integration and Secret2/2 pass locally. Controller orchestration remains separate.

- [WP-2252](./work-packages/WP-2252.md) isolates foreground Cart responses from newer Session
  contexts. PWA339/339, PWA security52/52, full final verification, forced uncached integration
  and Secret2/2 pass locally. Checkout response hardening remains separate.

- [WP-2251](./work-packages/WP-2251.md) connects current-session-authorized Pickup removal
  to optional local HTTP composition. Ordering390/390, API279/279, Cart PostgreSQL6/6, full
  verification, forced uncached integration and Secret2/2 pass locally. Add/Update remain separate.

- [WP-2250](./work-packages/WP-2250.md) coordinates opt-in foreground Pickup Cart creation
  and original-candidate continuation. PWA322/322, Cart PostgreSQL6/6, full verification, forced
  integration and Secret2/2 pass locally. Default App and item-write integration remain separate.

- [WP-2249](./work-packages/WP-2249.md) bounds Cart response headers and streamed body under
  one foreground deadline. PWA300/300, PWA security, full verification, forced uncached
  integration and Secret2/2 pass locally. Creation coordination and item wiring remain unfinished.

- [WP-2248](./work-packages/WP-2248.md) preserves unresolved customer Cart intent across
  retry, refresh and reconnect. PWA288/288, browser38/38, full verification, forced uncached
  integration and Secret2/2 pass locally. Response-body timeout and reload recovery remain separate.

- [WP-2247](./work-packages/WP-2247.md) composes explicit Identity/Ordering binding providers
  into the optional local runtime. API255/255, Cart PostgreSQL6/6, full verification, uncached
  integration and Secret2/2 pass locally. Page orchestration and item writes remain unfinished.

- [WP-2246](./work-packages/WP-2246.md) supplies the browser binding credential transport.
  PWA260/260, Cart PostgreSQL6/6, PWA security, full verification, uncached integration and
  Secret2/2 pass locally. Page orchestration remains separate.

- [WP-2245](./work-packages/WP-2245.md) connects the safe Cart query to the optional local
  HTTP runtime. API244/244, Session PostgreSQL5/5, Cart PostgreSQL6/6, full verification,
  uncached integration and Secret2/2 pass locally. Browser creation/recovery remains unfinished.

- [WP-2244](./work-packages/WP-2244.md) separates scoped read-only binding and Quote adapters
  from write configuration. Ordering370/370, Cart PostgreSQL6/6, full verification, uncached
  integration and Secret2/2 pass locally. Runtime wiring remains the next integration work.

- [WP-2243](./work-packages/WP-2243.md) composes the safe Pickup Cart view from authorized
  reads, historical Catalog names, public Store branding and exact-version Quote history.
  Catalog109/109, Store84/84, Ordering354/354, Cart PostgreSQL6/6, full local verification,
  uncached integration and Secret2/2 pass. Runtime/PWA composition remains unfinished.

- [WP-2242](./work-packages/WP-2242.md) implements a pinned historical Catalog display query
  and a separate scoped version reader. Catalog107/107, Published Menu PostgreSQL1/1, full
  verification and final uncached integration pass. Ordering display composition and browser
