...
- Source document version: `0.5.2`
- Architecture baseline: `v1.0`
- Current discussion node: `Closed — Section 90`
...
WP-0001 owns only the root workspace, governance, reproducible install, and `bootstrap / verify` CI baseline. It does not authorize applications, TypeScript source, databases, infrastructure, providers, or business behavior.
