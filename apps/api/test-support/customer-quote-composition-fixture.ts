// Synthetic owner facts for HTTP composition tests; no real Store or tax evidence.
import {
...
export const at = "2026-08-02T16:00:00.000Z";
...
export function quoteInput(overrides: Partial<CreatePriceQuoteInput> = {}): CreatePriceQuoteInput {
  return {
