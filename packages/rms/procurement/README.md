...
- Module: `@rms/procurement`; RMS Procurement & Supplier Domain; Later / WP-2131–2134; Procurement
  Engineering Owner.
...
`procurement_purchase_order_v1` provide permission-trimmed reads. Commands require Tenant, Brand,
...
external adapter is implemented in WP-2131–2134.
