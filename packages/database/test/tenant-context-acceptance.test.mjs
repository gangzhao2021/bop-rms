...
const expectedForcedTables = [
  "bop_feature_control.control_dependency",
  "bop_feature_control.control_operation",
  "bop_feature_control.control_version",
  ...
  "bop_identity.guest_binding_preparation",
  "bop_identity.guest_session",
  "bop_identity.guest_session_operation",
  ...
  "bop_permission.role",
  "bop_permission.role_administration_decision",
  "bop_permission.role_administration_operation",
  "bop_permission.role_administration_permission",
  "bop_permission.role_administration_version",
  "bop_permission.role_assignment",
  "bop_publishing.live_gate_operation",
  "bop_publishing.live_gate_requirement",
  "bop_publishing.live_gate_version",
  "bop_task.diagnostic_access_grant",
  "bop_task.diagnostic_access_revocation",
  "bop_task.support_action_record",
  "bop_task.support_case_operation",
  "bop_task.support_case_version",
  "bop_tenant.brand",
  "bop_tenant.brand_admin_operation",
  ...
  "rms_catalog.sku",
  "rms_device.device",
  "rms_device.device_assignment",
  "rms_device.device_capability_version",
  "rms_device.device_health_current",
  "rms_device.device_health_signal",
  "rms_device.device_operation",
  "rms_device.kds_profile",
  "rms_device.kds_profile_assignment",
  "rms_device.kds_profile_operation",
  "rms_device.kds_profile_version",
  "rms_device.kds_uat_check_result",
  "rms_device.kds_uat_run",
  "rms_fulfillment.fulfillment",
  "rms_fulfillment.fulfillment_completion_publication",
  ...
  "rms_fulfillment.pickup_handoff_item",
  "rms_fulfillment.pickup_handoff_operation",
  "rms_fulfillment.pickup_handoff_record",
  "rms_fulfillment.pickup_proof_generation",
  "rms_fulfillment.pickup_proof_invalidation",
  "rms_fulfillment.pickup_proof_operation",
  "rms_fulfillment.pickup_proof_verification",
  "rms_kitchen.kds_operator_handover",
  "rms_kitchen.kds_recovery_reconciliation",
  "rms_kitchen.kitchen_action_record",
  "rms_kitchen.kitchen_allergen_acknowledgement",
  ...
  "rms_ordering.cart",
  "rms_ordering.cart_binding_record",
  ...
  "rms_reporting.export_access_grant",
  "rms_reporting.export_artifact",
  "rms_reporting.export_grant_consumption",
  "rms_reporting.export_job",
  "rms_reporting.export_job_state_record",
  "rms_reporting.export_operation_record",
  "rms_reporting.export_revocation",
...
async function prove(context) {
  ...
  await admin.connect();
  try {
    assert.equal(expectedForcedTables.length, 140);
